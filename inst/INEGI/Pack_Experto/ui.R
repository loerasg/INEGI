...
shinyUI(fluidPage(titlePanel("Defunciones"),theme = shinytheme("cerulean"),#useShinyjs(),
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      h5("Código seleccionado:"),
      verbatimTextOutput("E3COD"),
      verbatimTextOutput("E3CapTex"),
      #wellPanel(h5("COD_SEL:"),h2(verbatimTextOutput("E3COD"))),
      checkboxGroupInput("E3_Cod_Int", "Consulta de código :",
                         c("Internet" = "intr",
                           "Base revisión" = "tabl",
                           "Tabla de límite" = "tabl_Codi"), inline = TRUE
                         #"label 3" = "option3",
                         #"label 4" = "option4"
                         #,
                         #selected = ""
      ),
      h4(actionButton("E3_sal", "Salir"),align = "right")
    ...
    mainPanel(
      fluidPage(
        ...
        fluidRow(
          column(width = 1, h3("  I"), 
                 h4(" a)",align = "right")),
          column(width = 7, h4("Causa de la defunción"),
                 verbatimTextOutput("E3Desc1")),
          column(width = 2,h4("Duración"),
        ...
        tags$hr(),
        fluidRow(
          column(3,textInput("Et3_Reg_Tex",  "Registro número:", value = "1")),#column(3,uiOutput("Et3_Num_reg")),
          column(2,actionButton("E3_Buscar_Reg", "Buscar"),align = "center"),
          column(5,verbatimTextOutput("E3Nul"),align = "center"),
          column(2,actionButton("E3Bot_Buscar", "Buscar pendiente"),align = "center")
        )
